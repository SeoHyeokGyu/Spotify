...
final class AuthManager{
    ...
    struct Constants {
        ...
        static let clientSecret = "8c610d8d68944c919ebf7a9d96ae5f31"
    ...
    private var tokenExpirationDate: Date?{
        return UserDefaults.standard.object(forKey: "expireationDate") as? Date
    }
    ...
    private var shouldRefreshToken: Bool{
        ...
        let fiveMinutes: TimeInterval = 3000000000
    ...
    public func exchangeCodeForToken(
        ...
        let basicToekn = Constants.clientID + ":" + Constants.clientSecret
        let data = basicToekn.data(using: .utf8)
